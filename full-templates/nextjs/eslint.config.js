// Generated by scripts/generate-configs.ts — edit shared/lint-format/eslint/eslint.config.nextjs-full.js instead.
...
const eslintConfig = [
  ...
  eslintConfigPrettier,
  {
    ...
    rules: {
      ...
      'jsx-a11y/anchor-has-content': ['error', { components: ['Link', 'TextLink'] }],
    },
    settings: {
