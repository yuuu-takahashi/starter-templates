...
for (const dir of SHARED_CONFIG_STACKS) {
  ...
  const nodeEslintContent = readFileSync(join(SHARED_ESLINT, "eslint.config.base.js"), "utf8");
  writeFileSync(join(ROOT, "templates/nodejs", "eslint.config.js"), GEN_HEADER_ESLINT.replace("<stack>", "base") + nodeEslintContent, "utf8");
