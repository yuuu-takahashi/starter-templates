...
for (const dir of SHARED_CONFIG_STACKS) {
  ...
  writeFileSync(join(ROOT, "templates/nodejs", "eslint.config.js"), GEN_HEADER_ESLINT.replace("<stack>", "nodejs") + nodeEslintContent, "utf8");
  ...
  const vitestConfigContent = VITEST_HEADER + readFileSync(join(SHARED_VITEST, "vitest.config.react-ts.ts"), "utf8");
