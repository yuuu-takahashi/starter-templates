...
const YAML_HEADER_RUBY_DB: string =
  '# Generated by scripts/generate-devcontainer.ts — edit shared/config/docker/docker-compose.ruby-db.yml instead.\n';
const YAML_HEADER_RAILS: string =
  '# Generated by scripts/generate-devcontainer.ts — edit shared/config/docker/docker-compose.rails.yml instead.\n';
...
function dockerfileHeader(srcFile: string): string {
  return `# Generated by scripts/generate-devcontainer.ts — edit shared/config/docker/${srcFile} and re-run.\n\n`;
}
...
function writeInitFirewall(outDir: string, templateDir: string): void {
  ...
  const withHeader = [
    lines[0],
    '# Generated by scripts/generate-devcontainer.ts — edit shared/config/docker/init-firewall.sh and scripts/lib/firewall-domains.ts, then re-run.',
    '',
    ...lines.slice(1),
  ].join('\n');
