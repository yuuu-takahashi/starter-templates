...
3. ネットワーク接続を確認`,
  ...
  },
  {
    ...
    setupSteps: [
      ...
      { label: '開発サーバー起動', commands: ['php artisan serve --port=3009'] },
    ],
  ...
  },
  {
    ...
    setupSteps: [
      ...
      {
        label: '開発サーバー起動',
        commands: ['dotnet run --urls http://localhost:3005'],
      },
    ],
  ...
  },
  {
    ...
    setupSteps: [
      ...
      {
        label: '開発サーバー起動',
        commands: ['. .venv/bin/activate && python manage.py runserver 3006'],
      },
    ],
