...
export const STACK_DEFINITIONS: readonly StackDefinition[] = [
  ...
  { dir: "templates/rails", id: "rails", runtime: "ruby", codeCheckWorkflow: "code-check-ruby-erb.yml", testWorkflow: "test-rails.yml", gitignore: ".gitignore.rails", devcontainerDockerfile: "Dockerfile.ruby", hasNpm: true, hasGemfile: true, monorepoPrefix: false },
