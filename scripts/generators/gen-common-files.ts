...
export const run = (): void => {
  try {
    ...
    // ── .dockerignore（shared/config/docker からフレームワーク別にコピー）────────────────────

    const DOCKER_DIR = join(ROOT, "shared", "config", "docker");
    const DOCKERIGNORE_HEADER = "# Generated by scripts/commands/generate-configs.ts — edit shared/config/docker/ instead.\n\n";
    ...
    const GITIGNORE_HEADER = "# Generated by scripts/commands/generate-configs.ts — edit shared/templates/gitignore/ instead.\n\n";
