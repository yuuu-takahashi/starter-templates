...
export const run = (): void => {
  try {
    ...
    const DOCKERIGNORE_HEADER = "# Generated by scripts/generate-configs.ts — edit shared/config/docker/ instead.\n\n";
    ...
    const GITIGNORE_HEADER = "# Generated by scripts/generate-configs.ts — edit shared/templates/gitignore/ instead.\n\n";
