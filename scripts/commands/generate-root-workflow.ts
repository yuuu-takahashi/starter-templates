 ...
 * from each template's .github/workflows/code-check.yml and shared/ci/workflows/test-*.yml.
...
const transformStepsForMonorepo = (
  steps: WorkflowStep[],
  dir: string,
): WorkflowStep[] => {
...
const header =
  "# Generated by yarn generate:ci - edit shared/ci/workflows/ or template's .github/workflows/ instead.\n\n";
