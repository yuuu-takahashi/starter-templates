 ...
 * for each template.
 *
 * - 拡張機能・VSCode 設定の共通定義 → shared/config/devcontainer/defaults.json を編集
...
const JSON_HEADER: string =
  '// Generated by scripts/commands/generate-devcontainer.ts — edit that file instead.\n';
const YAML_HEADER_RUBY_DB: string =
  '# Generated by scripts/commands/generate-devcontainer.ts — edit shared/config/docker/docker-compose.ruby-db.yml instead.\n';
const YAML_HEADER_RAILS: string =
  '# Generated by scripts/commands/generate-devcontainer.ts — edit shared/config/docker/docker-compose.rails.yml instead.\n';
...
function dockerfileHeader(srcFile: string): string {
  return `# Generated by scripts/commands/generate-devcontainer.ts — edit shared/config/docker/${srcFile} and re-run.\n\n`;
}
...
function writeInitFirewall(outDir: string, templateDir: string): void {
  ...
  const withHeader = [
    lines[0],
    '# Generated by scripts/commands/generate-devcontainer.ts — edit shared/config/docker/init-firewall.sh and scripts/lib/firewall-domains.ts, then re-run.',
    '',
    ...lines.slice(1),
  ].join('\n');
