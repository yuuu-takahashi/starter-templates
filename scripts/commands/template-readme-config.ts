...
3. ネットワーク接続を確認`,
  ...
  },
  {
    ...
    selectNumber: 6,
    selectLabel: 'Ruby on Rails - Full',
  },
  {
    id: 'laravel',
  ...
  },
  {
    ...
    npmStack: 'rails-api',
    gemfileStack: 'rails-api',
    extensionSets: ['base', 'ruby', 'node', 'tooling'],
    setupSteps: [
      { label: 'データベース準備', commands: ['bin/rails db:prepare'] },
      { label: '開発サーバー起動', commands: ['bin/rails s'] },
    ],
    ...
    devGuide: [
      ...
      { title: 'セキュリティスキャン', commands: 'bundle exec brakeman' },
    ],
    selectNumber: 8,
    selectLabel: 'Rails API - Full',
  },
  {
    id: 'csharp',
